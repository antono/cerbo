...
The `cerbo` CLI tool SHALL ship with a Unix man page that documents all commands, arguments, storage model, and usage conventions. The man page source is maintained in Markdown and converted to troff format during build.
