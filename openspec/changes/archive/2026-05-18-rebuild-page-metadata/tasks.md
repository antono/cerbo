...
- [x] 7.3 Add usage examples to README or docs (all scopes: all/vault/page)
- [x] 7.4 Document when to use `cerbo index` (recovery workflow after manual edits/imports)
