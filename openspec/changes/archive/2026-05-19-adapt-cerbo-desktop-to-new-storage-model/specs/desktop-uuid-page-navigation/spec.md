# Desktop UUID Page Navigation

## Purpose
Define how the cerbo-desktop frontend identifies, opens, and tracks pages using UUID as the sole page identifier, replacing the prior slug-based model.
