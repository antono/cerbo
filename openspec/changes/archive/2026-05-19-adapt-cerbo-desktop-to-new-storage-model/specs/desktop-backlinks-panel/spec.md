# Desktop Backlinks Panel

## Purpose
Define the desktop-layer contract for the backlinks panel: the `BacklinkEntry` type, the `backlinks_get` Tauri command resolution behaviour, and how the frontend navigates from a backlink to its source page.
